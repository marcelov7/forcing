        ...
        <div class="card-body">
            <form method="GET" action="{{ route('forcing.index') }}" id="filtroForm">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label">🔍 Buscar TAG/Equipamento</label>
                    ...
                    <!-- Filtro por Situação -->
                    <div class="col-md-2">
                        <label class="form-label">⚙️ Situação</label>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('forcing.index') }}" class="btn btn-outline-secondary">
                                <i class="fas fa-times"></i> Limpar
                            </a>
                            <button type="button" class="btn btn-outline-info" onclick="aplicarFiltrosRapidos('forcado')">
                                ⚠️ Ativos
                            </button>
                            <button type="button" class="btn btn-outline-success" onclick="aplicarFiltrosRapidos('retirado')">
                                ✅ Concluídos
                            </button>
                            <button type="button" class="btn btn-outline-warning" onclick="aplicarFiltrosRapidos('solicitacao_retirada')">
                                🔔 Pendente Retirada
                            </button>
                        </div>
                    </div>
...
@if($forcings->count() > 0)
    <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($forcing->data_retirada)
                                                <small>{{ $forcing->data_retirada->format('d/m/Y H:i') }}</small>
                                            @else
                                                <span class="text-muted">-</span>
                                            @endif
                                        </td>
        ...
        <!-- Modais adicionais para o novo fluxo -->
        @foreach($forcings as $forcing)
