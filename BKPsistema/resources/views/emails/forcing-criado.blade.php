...
@section('title', 'Novo Forcing Criado')
@section('subtitle', 'Um novo forcing foi criado e precisa de liberação')

@section('content')
    <h2>🆕 Novo Forcing Criado</h2>
    ...
    <div style="text-align: center; margin: 30px 0;">
        <a href="{{ route('forcing.show', $forcing->id) }}" class="btn">
            🔍 Ver Detalhes do Forcing
        </a>
        <a href="{{ route('forcing.index') }}" class="btn">
            📋 Acessar Sistema
        </a>
    </div>
