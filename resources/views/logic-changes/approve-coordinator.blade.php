...
@section('title', 'Aprovação - Coordenador de Manutenção')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="fas fa-user-cog"></i> Aprovação - Coordenador de Manutenção
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('logic-changes.approve-coordinator', $logicChange) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="observacoes_coordenador_manutencao" class="form-label">Observações (opcional)</label>
                            <textarea class="form-control" id="observacoes_coordenador_manutencao" name="observacoes_coordenador_manutencao" 
                                      rows="4" placeholder="Adicione observações sobre esta aprovação..."></textarea>
                        </div>

                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-check"></i> Aprovar como Coordenador de Manutenção
                            </button>
