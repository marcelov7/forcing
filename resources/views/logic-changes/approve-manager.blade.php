...
@section('title', 'Aprovação - Gerente de Manutenção')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">
                        <i class="fas fa-user-tie"></i> Aprovação - Gerente de Manutenção
                    </h5>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('logic-changes.approve-manager', $logicChange) }}" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="observacoes_gerente_manutencao" class="form-label">Observações (opcional)</label>
                            <textarea class="form-control" id="observacoes_gerente_manutencao" name="observacoes_gerente_manutencao" 
                                      rows="4" placeholder="Adicione observações sobre esta aprovação..."></textarea>
                        </div>

                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success">
                                <i class="fas fa-check"></i> Aprovar como Gerente de Manutenção
                            </button>
