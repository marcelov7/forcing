                ...
                <div class="modal-content">
                    <form action="{{ route('forcing.liberar', $forcing) }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <label for="observacoes_liberacao{{ $forcing->id }}" class="form-label">Observações</label>
                                <textarea class="form-control" id="observacoes_liberacao{{ $forcing->id }}" 
                                          name="observacoes_liberacao" rows="3" placeholder="Observações sobre a liberação (opcional)"></textarea>
                            </div>
                        </div>
